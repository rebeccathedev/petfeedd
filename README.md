...
2. `docker pull rebeccathedev/petfeedd-arm32v7:0.2`. Be patient, it will take a bit.
...
```
$ docker run -d --restart always --privileged -v /opt/petfeedd.db:/petfeedd/petfeedd.db -v /etc/petfeedd.conf:/petfeedd/petfeedd.conf -p 0.0.0.0:8080:8080 -p 0.0.0.0:11211:11211 rebeccathedev/petfeedd-arm32v7
```
