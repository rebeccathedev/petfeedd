    ...
    <div v-if="enable">
      ...
      <div class="row mt-2">
        ...
        <div class="col-md-6">
          ...
          <input type="email" class="form-control" id="from_address" placeholder="me@rebeccapeck.org" v-model="from_address">
        </div>
      </div>
      ...
      <div class="row mt-2">
        ...
        <div class="col-md-6">
          ...
          <input type="text" class="form-control" id="password" placeholder="me@rebeccapeck.org" v-model="password">
        </div>
      </div>
