...
```
$ docker run --privileged -v /etc/localtime:/etc/localtime -v /opt/petfeedd.db:/opt/petfeedd.db -p 0.0.0.0:8080:8080 rebeccathedev/petfeedd
```
...
```
$ docker run -d --restart always --privileged -v /etc/localtime:/etc/localtime -v /opt/petfeedd.db:/opt/petfeedd.db -v /etc/petfeedd.conf:/petfeedd/petfeedd.conf -p 0.0.0.0:8080:8080 rebeccathedev/petfeedd
```
